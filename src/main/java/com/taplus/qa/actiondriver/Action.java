 ...
 * 
 */
package com.taplus.qa.actiondriver;
...
import com.taplus.qa.actioninterface.ActionInterface;
...
public class Action extends TestBase implements ActionInterface {
	 ...
	 * boolean flag = false; try { new WebDriverWait(driver,15)
	 * .until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//iframe")) );
	 * driver.switchTo().frame(index); flag = true; return true; } catch (Exception
	 * e) {
	 * 
	...
	/*
	 * @Override public void explicitWait(WebDriver driver, WebElement element, int
	 * timeOut) { // TODO Auto-generated method stub
	 * 
	 * }
	 */
